<!DOCTYPE html>
<html lang="en">
<?php include('assets/process/config.php') ?>
...
<head>
  ...
  <script src="assets/js/search_applicant.js"></script>
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto " href="incoded_list.php">Back</a></li>
            ...
            <div class="col-12 col-lg-9 col-xl-7">
              <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                <div class="card-body p-4 p-md-5">
                  <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Update Encoded Applicant</h3>
                  <!--Search field of applicant using name for EDIT/UPDATE-->
                  <?php include('assets/include/option_applicant_name.php'); ?>
                  <br>

                  <form action="assets/process/update_encode.php" method="post" enctype="multipart/form-data">
                    <div class="form-outline">
                      <input type="text" id="applicantId" name="applicantId" class="form-control form-control-lg" readonly />
                      <label class="form-label" for="applicantId">Applicant ID</label>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="form-outline">
                      <input type="file" id="resume" name="resume" class="form-control form-control-lg" accept=".pdf,.docx" />
                      <label class="form-label" for="resume">Insert Resume</label>
                    </div>
                    <!-- Position and Employer Field-->
                    <?php include('assets/include/option_position.php'); ?>
  ...
  <script src="assets/js/position_select.js"></script>
