...
<body>
  ...
  <main id="main">
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container job-container">
        ...
        <input type="text" id="nameFilter" class="form-control form-control-lg" placeholder="Search Applicant">
        </div>
        <br><br>
        <?php include('assets/include/applicant_incoded_table.php'); ?>
      </div>
    </section>
  </main><!-- End #main -->
  ...
  <script src="assets/js/search_encode.js"></script>
