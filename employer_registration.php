...
<body>
                ...
                <div class="card-body p-4 p-md-5">
                  ...
                  <div class="com-info" id="comInfo">
                    ...
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="comName" name="comName"
                        class="form-control form-control-lg" required />
                      <label class="form-label" for="comName">Company Name</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="ownerCeo" name="ownerCeo"
                        class="form-control form-control-lg" required />
                      <label class="form-label" for="">President/CEO</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="representative" name="representative"
                        class="form-control form-control-lg" required />
                      <label class="form-label" for="">Representative</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="address" name="address"
                        class="form-control form-control-lg" required />
                      <label class="form-label" for="">Address</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="tel" id="phoneNumber" name="phoneNumber"
                    ...
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="email" id="emailAddress" name="emailAddress"
                        class="form-control form-control-lg" required />
                      <label class="form-label" for="">Email</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="website" name="website"
                        class="form-control form-control-lg" />
                      <label class="form-label" for="website">website</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="twitter" name="twitter"
                        class="form-control form-control-lg" />
                      <label class="form-label" for="">Twitter</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="facebook" name="facebook"
                        class="form-control form-control-lg" />
                      <label class="form-label" for="">Facebook</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="instagram" name="instagram"
                        class="form-control form-control-lg" />
                      <label class="form-label" for="">instagram</label>
                    </div>
                    <br><br>
                    <div class="form-outline">
                      <input form="formSubmit" type="text" id="Linkedin" name="Linkedin"
                        class="form-control form-control-lg" />
                      <label class="form-label" for="">Linkedin</label>
                    </div>

                    <div class="button"> <button type="submit" class="next" id="comInfonext">Next</button> <i
                  ...
                  <div class="overview" id="overview" style="display: none;">
                    ...
                    <div class="file-upload">
                      ...
                      <div class="image-upload-wrap">
                        <input class="file-upload-input" id="employerLogo" name="employerLogo" form="formSubmit"
                          type='file' onchange="readURL(this);" accept="image/*" required />
                        <div class="drag-text">
                    ...
                    <div class="company-size">
                      <div class="form-outline">
                        <input form="formSubmit" type="tel" id="minimum" name="minimum"
                          class="form-control form-control-lg"
                          oninput="this.value = this.value.replace(/[^0-9]/g, '');javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                          maxlength="11" required />
                      ...
                      <h1> - </h1>
                      <div class="form-outline">
                        <input form="formSubmit" type="tel" id="maximum" name="maximum"
                          class="form-control form-control-lg"
                          oninput="this.value = this.value.replace(/[^0-9]/g, '');javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                          maxlength="11" required />
                    ...
                    <div class="form-outline">
                      ...
                      <textarea form="formSubmit" name="inputOverview" id="inputOverview" cols="60"
                        rows="17"></textarea>
                    </div>
                    ...
                    <br>
                    <div class="form-outline">
                      <input type="text" form="formSubmit" id="validation" name="validation"
                        class="form-control form-control-lg" />
                      <label class="form-label" for="">Company Registration Number/POEA Registration</label>
                    </div>
                    <div class="button"> <button id="backDiv">Back</button> <i class="fa fa-angle-right"></i> </div> <i
                      class="fa fa-arrow-left back_page"></i>
                    <div class="button"> <button id="showAccount">Next</button> <i class="fa fa-angle-right"></i> </div>
                  ...
                  <div id="accountDiv" style="display:block;">
                    ...
                    <form id="formSubmit" action="assets/process/employer_register.php" method="post"
                      ...
                      <div class="row-contain">
                        ...
                        <div class="free-sub" onclick="selectRadio('freeTrail')">
                          <div class="sub-row">
                            <input type="radio" name="subs" id="freeTrail">
                            <label for="freeTrail">Free Trail</label>
                          </div>
                          <p>-Can Post 5 jobs
                            <br>
                            -Up to 10 applicant per job
                            <br>
                            -viewing resume count as one
                          </p>
                        </div>

                        <div class="free-sub" onclick="selectRadio('monthly')">
                          <div class="sub-row">
                            <input type="radio" name="subs" id="monthly">
                            <label for="monthly">Monthly</label>
                          </div>
                          <p>
                            -Can Post 100 jobs
                            <br>
                            -Up to 50 applicant per job
                            <br>
                            -viewing resume count as one
                            <br>
                            -Job reposting/Management
                            <br>
                            -Applicant Management
                          </p>
                        </div>

                        <div class="free-sub" onclick="selectRadio('yearly')">
                          <div class="sub-row">
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Counterpart Resource Multi Purpose Cooperative</span></strong>. All Rights
        Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
